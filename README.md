...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-04 00:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/be563fc5-fed2-4838-b0b9-eecd59d5b7e2.git
$ cd be563fc5-fed2-4838-b0b9-eecd59d5b7e2
```
